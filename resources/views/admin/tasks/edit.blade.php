        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('quickadmin.tasks.fields.title').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('equipment_id', trans('quickadmin.tasks.fields.equipment').'*', ['class' => 'control-label']) !!}
                    {!! Form::select('equipment_id', $equipment, old('equipment_id'), ['class' => 'form-control select2', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('start_time', trans('quickadmin.tasks.fields.start-time').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('end_time', trans('quickadmin.tasks.fields.end-time').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('employee_id', trans('quickadmin.tasks.fields.employee').'*', ['class' => 'control-label']) !!}
