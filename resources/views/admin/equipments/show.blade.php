                ...
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <td field-key='name'>{{ $equipment->name }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.equipments.fields.is-available')</th>
                            <td field-key='is_available'>{{ Form::checkbox("is_available", 1, $equipment->is_available == 1 ? true : false, ["disabled"]) }}</td>
                        </tr>
                    </table>
                </div>
            </div><!-- Nav tabs -->
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.equipments.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
